...
class Settings(BaseSettings):
    ...
    CORS_ORIGINS: str = "http://localhost:3000,http://127.0.0.1:3000,https://frontend-nine-woad-19.vercel.app,https://insightai-app.vercel.app,https://chetan-insightai.vercel.app"
